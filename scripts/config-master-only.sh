...
checkAndDoit(){
  ...
  echo "*********************************************************************************************************"
  echo "*   NOTE:                                                                                               *"
  echo "*       1. Please make sure your config is right !                                                      *"
  echo "*       2. Before install k8s-master,You must make sure configed such as:                               *"
  echo "*          config env,install docker,load images,config kubelet ,and so on.                             *"
  echo "*********************************************************************************************************"
  ...
  if [ "${answer}" = "yes" -o "${answer}" = "y" ];then
    ...
    echo "*                  You can run installk8s.sh for installing components at second!                       *"
  	echo "*********************************************************************************************************"
  	exit 1
  fi
}
